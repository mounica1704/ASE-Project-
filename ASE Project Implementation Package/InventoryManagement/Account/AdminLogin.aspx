...
<body>
  ...
  <%--  <a href="../Default.aspx">
     ...
     <div class="container">
         ...
         <div class="col-lg-12">  
             <p>
     <img src="../images/warehouse1.png"    width="100%"  /></p>
    </div>
                 </div>
  ...
  <div class="panel-body">
    ...
    Username: <input type="text" required name="UserName" class="form-control" id="txtUsername" runat="server"><br>
    Password: <input type="password" required name="pwd"  class="form-control" id="txtPassword" runat="server">
    <input type="submit" onserverclick="AdminLogIn" class="btn btn-default" value="Submit" runat="server">
</form>
      </div>
                     </div>
<label id="LoginFailure" runat="server" visible="false" style="color:red">Invalid Username and/or passwords</label> </div>
             </div>
...
<div id="footer" class="alert alert-info" >
    ...
    <button type="button" onclick="location.href = '../Account/frmRegistration.aspx';">Register</button><br />
    </div>
        </div>
