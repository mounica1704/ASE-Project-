<%@ Page Language="C#" MasterPageFile="~/MasterPageMain.master" AutoEventWireup="true" CodeFile="frmManageUserOrdersAdmin.aspx.cs" Inherits="Admin_frmManageUserOrders" Title="Manage Orders" %>
...
<asp:BoundField HeaderText="UserOrderId" ReadOnly="true" Visible="true"  DataField="UserOrderId"/> 
<asp:BoundField HeaderText="UserName" ReadOnly="true"  DataField="UserName" />
    <asp:BoundField HeaderText="UserOrderDate" ReadOnly="true"  DataField="UserOrderDate" />
