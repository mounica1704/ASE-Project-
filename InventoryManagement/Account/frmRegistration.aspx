<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="frmRegistration.aspx.cs" Inherits="frmRegistration" Title="User Registration Page" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDesignation" ErrorMessage="*"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
